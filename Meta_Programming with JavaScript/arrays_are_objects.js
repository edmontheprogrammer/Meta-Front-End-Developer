/*
    ...
    In JavaScript, arrays are objects. That means that arrays also have some built-in properties
    One of the most commonly used built-in methods on arrays are the "push()" and the "pop()"
    methods

    To add new items to an arry, I can use the "push()" method:
*/
...
/*
    Tying into some earlier lessons in this course, I can now build a function that takes all its 
    arguments and pushes them into an array, like this:
*/
...
/*
    * Additionally, I can save this function call to a variable. 
    I can name it anything, but this time I'll the name: "simpleArr"
*/
